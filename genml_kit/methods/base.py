...
class Method(abc.ABC):
    ...
    def get_trainer_class(cls):
        ...
        Default is BaseTrainer.  RL methods override to return RLTrainer.
        This avoids hardcoding trainer selection by pipeline NAME in the driver.
        """
    ...
    def log_validation(  # noqa: B027
        self, model, loader, to_device, writer, global_step, device, num_samples=8
    ):
