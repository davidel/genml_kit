...
class MultiCropTransform(nn.Module):
    ...
    :meth:`genml_kit.models.dino.DINO.forward`.
    ...
    def __init__(
        ...
        self.global_crop = v2.RandomResizedCrop(
            global_size, scale=global_scale, interpolation=v2.InterpolationMode.BICUBIC
        )
        self.local_crop = v2.RandomResizedCrop(
            local_size, scale=local_scale, interpolation=v2.InterpolationMode.BICUBIC
        )
    ...
    return v2.Compose(
        [
            ...
            v2.RandomApply(
                [
                    v2.ColorJitter(
                        brightness=0.4, contrast=0.6, saturation=0.8, hue=0.1
                    ),
                ],
                p=0.8,
            ),
